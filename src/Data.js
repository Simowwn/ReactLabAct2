export const collectiblesData = [
  {
    photoName: "https://smiski.com/e/wp-content/uploads/2016/09/3_3.png",
    name: "Smiski Bridge",
  ...
  {
    photoName: "https://smiski.com/e/wp-content/uploads/2016/09/3_4.png",
    name: "Smiski Peeking",
    body: "Body Type: Slim",
    pose: "Pose: Peeking Down",
    found: "Found: On top of objects and shelves",
    description:
  ...
  },
  {
    ...
    pose: "Pose: Rope climbing",
    found: "Found: Around ropes, strings, cords",
    description:
  ...
  {
    photoName: "https://smiski.com/e/wp-content/uploads/2016/09/3_6.png",
    name: "Smiski Little",
    body: "Body Type: Normal",
    pose: "Pose: One hand against the wall",
    found: "Found: Near walls",
    description:
      "Little Smiski have made their appearance! For some reason these little ones like to line up against the wall in this pose.",
  },
  {
    photoName: "https://smiski.com/e/wp-content/uploads/2016/09/3_7.png",
    name: "Smiski Hiding",
    body: "Body Type: Normal",
    pose: "Pose: under something",
    found: "Found: Underneath towels and blankets",
    description:
